...
wp plugin install https://github.com/woocommerce/wc-smooth-generator/zipball/master/ --allow-root
composer self-update --1
composer install -d plugins/master/
wp plugin activate master --allow-root
